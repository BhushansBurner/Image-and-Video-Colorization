...
def color(loc):
    ...
    net = cv2.dnn.readNetFromCaffe(r"C:\Users\Bhushan\Desktop\Project\bw-colorization\model\colorization.prototxt",r"C:\Users\Bhushan\Desktop\Project\bw-colorization\model\colorization.caffemodel")
    pts = np.load(r"C:\Users\Bhushan\Desktop\Project\bw-colorization\model\pts_in_hull.npy")
